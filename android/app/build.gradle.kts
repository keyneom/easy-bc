...
android {
    ...
    buildTypes {
        debug {
            // Opt-in isolated installs for device QA; the normal app id is unchanged.
            applicationIdSuffix = providers.gradleProperty("easybc.testApplicationIdSuffix").orNull
        }
        release {
